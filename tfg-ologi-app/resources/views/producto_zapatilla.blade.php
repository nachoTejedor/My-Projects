...
<head>
    ...
    <title>Zapatillas Ologi - Ologi Designs</title>
    <meta name="description" content="Descubre nuestras sudaderas Ologi. Diseños únicos y de alta calidad.">
...
<body>
    <nav>
        ...
        <ul>
            ...
            <li><a class="active"href="/zapatillas">Zapatillas</a></li>
            <li><a href="#footer">Contacto</a></li>
        </ul>
    </nav>
    <div class="container-title">ZAPATILLAS</div>
